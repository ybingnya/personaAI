...
|-------|-------|
| Method | `POST` |
| URL | `https://app-e8yvrjq9s9hd-api-GYX1lzGw0DQa.gateway.appmedo.com/image-generation/task` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-e8yvrjq9s9hd-api-GYX1lzGw0DQa.gateway.appmedo.com/image-generation/task",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
