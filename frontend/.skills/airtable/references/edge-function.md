...
const actions = {
  ...
  list_bases: {
    url: "https://app-e8yvrjq9s9hd-api-connect-airtable-list-bases.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_base_schema: {
    url: "https://app-e8yvrjq9s9hd-api-connect-airtable-get-base-schema.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_records: {
    url: "https://app-e8yvrjq9s9hd-api-connect-airtable-list-records.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_record: {
    url: "https://app-e8yvrjq9s9hd-api-connect-airtable-get-record.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_records: {
    url: "https://app-e8yvrjq9s9hd-api-connect-airtable-create-records.gateway.appmedo.com/",
    callers: "authenticated",
  },
  update_records: {
    url: "https://app-e8yvrjq9s9hd-api-connect-airtable-update-records.gateway.appmedo.com/",
    callers: "authenticated",
  },
  delete_records: {
    url: "https://app-e8yvrjq9s9hd-api-connect-airtable-delete-records.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
