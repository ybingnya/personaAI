...
const actions = {
  search_messages: {
    url: "https://app-e8yvrjq9s9hd-api-connect-gmail-search-messages.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_message: {
    url: "https://app-e8yvrjq9s9hd-api-connect-gmail-get-message.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_thread: {
    url: "https://app-e8yvrjq9s9hd-api-connect-gmail-get-thread.gateway.appmedo.com/",
    callers: "authenticated",
  },
  // The caller chooses the recipient, so a public sender is an open relay.
  send_email: {
    url: "https://app-e8yvrjq9s9hd-api-connect-gmail-send-email.gateway.appmedo.com/",
    callers: "authenticated",
  },
  modify_message_labels: {
    url: "https://app-e8yvrjq9s9hd-api-connect-gmail-modify-message-labels.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
