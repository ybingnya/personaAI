...
const actions = {
  ...
  get_current_user: {
    url: "https://app-e8yvrjq9s9hd-api-connect-calendly-get-current-user.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_event_types: {
    url: "https://app-e8yvrjq9s9hd-api-connect-calendly-list-event-types.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_available_times: {
    url: "https://app-e8yvrjq9s9hd-api-connect-calendly-list-available-times.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_scheduled_events: {
    url: "https://app-e8yvrjq9s9hd-api-connect-calendly-list-scheduled-events.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_event_invitees: {
    url: "https://app-e8yvrjq9s9hd-api-connect-calendly-list-event-invitees.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_scheduling_link: {
    url: "https://app-e8yvrjq9s9hd-api-connect-calendly-create-scheduling-link.gateway.appmedo.com/",
    callers: "authenticated",
  },
  cancel_scheduled_event: {
    url: "https://app-e8yvrjq9s9hd-api-connect-calendly-cancel-scheduled-event.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
