...
description: Read calendars and create, update, or delete events through fixed reviewed Google Calendar actions.
license: MIT
---

# Google Calendar

Use this Skill for the fixed Calendar actions below. Invoke the bundled program with one JSON object on stdin:
