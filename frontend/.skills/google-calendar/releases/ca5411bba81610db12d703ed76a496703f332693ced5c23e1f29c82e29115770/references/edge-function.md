...
const actions = {
  find_event: {
    url: "https://api-connect-google-calendar-find-event@third.party.domain/",
    callers: "authenticated",
  },
  // Calendar metadata only — no event content.
  list_calendars: {
    url: "https://api-connect-google-calendar-list-calendars@third.party.domain/",
    callers: "public",
  },
  list_events: {
    url: "https://api-connect-google-calendar-list-events@third.party.domain/",
    callers: "authenticated",
  },
  create_event: {
    url: "https://api-connect-google-calendar-create-event@third.party.domain/",
    callers: "authenticated",
  },
  update_event: {
    url: "https://api-connect-google-calendar-update-event@third.party.domain/",
    callers: "authenticated",
  },
  delete_event: {
    url: "https://api-connect-google-calendar-delete-event@third.party.domain/",
    callers: "authenticated",
  },
} as const;
```
