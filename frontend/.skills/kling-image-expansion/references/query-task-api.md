...
| Item | Details |
|------|---------|
| Endpoint | `GET https://app-e8yvrjq9s9hd-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/{task_id}` |
...
| Item | Details |
|------|---------|
| Endpoint | `GET https://app-e8yvrjq9s9hd-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-e8yvrjq9s9hd-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/${task_id}`,
    {
      method: "GET",
      headers: {
