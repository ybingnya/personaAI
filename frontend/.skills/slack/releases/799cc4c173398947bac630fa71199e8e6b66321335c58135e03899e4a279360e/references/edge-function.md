...
const actions = {
  ...
  find_channels: {
    url: "https://api-connect-slack-find-channels@third.party.domain/",
    callers: "public",
  },
  // Free-text search across the workspace; there is no target to pin.
  search_messages: {
    url: "https://api-connect-slack-search-messages@third.party.domain/",
    callers: "authenticated",
  },
  get_channel_history: {
    url: "https://api-connect-slack-get-channel-history@third.party.domain/",
    callers: "authenticated",
  },
  send_message: {
    url: "https://api-connect-slack-send-message@third.party.domain/",
    callers: "authenticated",
  },
} as const;
```
