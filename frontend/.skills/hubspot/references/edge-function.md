...
const actions = {
  ...
  search_contacts: {
    url: "https://app-e8yvrjq9s9hd-api-connect-hubspot-search-contacts.gateway.appmedo.com/",
    callers: "authenticated",
  },
  search_companies: {
    url: "https://app-e8yvrjq9s9hd-api-connect-hubspot-search-companies.gateway.appmedo.com/",
    callers: "authenticated",
  },
  search_deals: {
    url: "https://app-e8yvrjq9s9hd-api-connect-hubspot-search-deals.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
