...
| Property | Value |
|----------|-------|
| **Endpoint** | `POST https://app-e8yvrjq9s9hd-api-eLMlJj3KJD89.gateway.appmedo.com/v1/videos/image2video` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-e8yvrjq9s9hd-api-eLMlJj3KJD89.gateway.appmedo.com/v1/videos/image2video",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
