...
const actions = {
  ...
  list_workspaces: {
    url: "https://app-e8yvrjq9s9hd-api-connect-clickup-list-workspaces.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_spaces: {
    url: "https://app-e8yvrjq9s9hd-api-connect-clickup-list-spaces.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_folders: {
    url: "https://app-e8yvrjq9s9hd-api-connect-clickup-list-folders.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_lists: {
    url: "https://app-e8yvrjq9s9hd-api-connect-clickup-list-lists.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_folderless_lists: {
    url: "https://app-e8yvrjq9s9hd-api-connect-clickup-list-folderless-lists.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_tasks: {
    url: "https://app-e8yvrjq9s9hd-api-connect-clickup-list-tasks.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_task: {
    url: "https://app-e8yvrjq9s9hd-api-connect-clickup-create-task.gateway.appmedo.com/",
    callers: "authenticated",
  },
  update_task: {
    url: "https://app-e8yvrjq9s9hd-api-connect-clickup-update-task.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
